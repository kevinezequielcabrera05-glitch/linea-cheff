...
import hornosData from "../../data/hornos.json";
import ModalCatalog from "../molecules/ModalCatalog.jsx";

function FurnanceCatalog() {
  const [openModal, setOpenModal] = useState(false);
  const [productoSeleccionado, setProductoSeleccionado] = useState(null);

  const handleConsultarPrecio = (producto) => {
    const mensaje = `Hola! Estoy interesado en el horno "${producto.nombre}". ¿Podrían confirmarme el precio?`;
...
export default FurnanceCatalog;
